        ...
        <div className="relative z-10 flex flex-col justify-center px-12 py-16 text-white">
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-4">
              Welcome to <span className="text-[#f5a837]">LearnCoz</span>
            </h1>
            <p className="text-xl text-blue-100 leading-relaxed">
              Master the skills that shape the future of technology with our comprehensive online learning platform.
            </p>
          </div>
          ...
          <div className="mt-12">
            <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-xl p-6">
              <h3 className="text-xl font-bold mb-3">Why Choose LearnCoz?</h3>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">
              Welcome to <span className="text-[#0075eb]">LearnCoz</span>
            </h1>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" className="text-sm text-[#0075eb] hover:underline">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-600">
                ...
                <Link to="/register" className="text-[#0075eb] font-semibold hover:underline">
                  Sign Up
                </Link>
              </p>
            </div>
